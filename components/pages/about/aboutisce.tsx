...
export default function AboutIsce() {
			...
			<div className='mt-20 '>
				...
				<div className='items-center justify-center text-white mx-auto'>
					...
					<div className=' text-white p-12'>
						<div className='xl:max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12'>
							<div className='flex'>
								<CircleIcon className='text-[#f15a24] xl:mr-4 mx-4' />
								<div>
    ...
    <MaxWidthContainer className="mx-auto ">
      <div className="mt-20 ">
        ...
        <div className="space-y-6 w-full my-5 justify-center items-center ">
          <Image
            width={1200}
            height={1200}
            src="/images/group.jpg"
