...
export function HeaderCarouselDisplay({
  header,
  content,
  link,
  className,
...
export const HeaderCarouselDisplayV2 = ({
  header,
  content,
  link,
  className,
  ...
  return (
    <div className="h-screen overflow-clip">
      ...
      <div className="text-white absolute bottom-0 w-full z-20">
        <MaxWidthContainer className="flex flex-col gap-3">
          <Image src="/fi-white.webp" alt="text" height="300" width="300" />
          <p className="w-[80%] lg:w-[60%] mt-[20px] text-[17px]">{content}</p>
          <Button
            asChild
            className="transition-all duration-300 cursor-pointer hover:bg-black hover:text-white hover:border border-white text-black bg-white py-3 px-5 w-min"
          >
