...
export default function CartPage() {
  ...
  return (
    <MaxWidthContainer className="container pt-20">
      <motion.h1
                  ...
                  return (
                    ...
                    >
                      <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-2 flex items-center justify-center text-foreground">
                          <div className="flex items-center">
                            ...
                            <div className="h-8 w-10 text-white flex items-center justify-center border-y border-input">
                              {item.quantity}
                            </div>
                            <motion.div
                              whileHover={{ scale: 1.1 }}
        ...
        >
          <div className="rounded-lg border border-border overflow-hidden">
            ...
            <div className="p-4 space-y-4">
              ...
              {/* Show customization fees if any */}
