...
export const products: Product[] = [
  ...
  },
  {
    id: "nfc-keychain",
    name: "NFC Keychain",
    description: "Durable keychain with embedded NFC chip for quick access to your digital profile.",
  ...
  },
  {
    ...
    description: "Bulk pack of NFC business cards perfect for teams and companies.",
    price: 1200000, // 120,000 NGN
    deviceType: "CARD",
    images: [
