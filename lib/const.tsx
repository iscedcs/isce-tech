...
export const PROJECT_ITEM: IPROJECT[] = [
	{
		...
		figlink: 'https://www.figma.com/file/RFbWimhXksL0rVeMUTLfTO/ARIARIA-NG.COM-(Copy)?type=design&node-id=3%3A2&mode=design&t=2utpT2hM5PbwnjOG-1',
		hasFigLink: true,
	},
	{
		...
		figlink: 'https://www.figma.com/file/g1s1367l2cGU1yL59q8wkt/TRANSPAY?type=design&node-id=131%3A1112&mode=design&t=FfpPS5wV9Ds378Zp-1',
		hasFigLink: true,
	},
	{
